...
while True:
    try:
        ...
        print("Матриця планування експерименту при k=3 із нормованими значеннями факторів")
        print(table1, "\n")
        ...
        print("Матриця планування експерименту при k=3 із натуралізованими значеннями факторів")
        print(table2)
        ...
        if Gp < Gt:
            ...
            for i in range(11):
                if ((abs(globals()['beta%s' % (i)]) / sbs) < ttabl):
                    print("t%s < ttabl, b%s не є значущим" % (i, i))
                    globals()['b%s' % i] = 0
                    d = d - 1
            ...
            print("Дисперсія  є неоднорідною - варто збільшити m")
